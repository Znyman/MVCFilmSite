...
<h2>Would you like to modify this film?</h2>
    ...
    <input type="number" class="form-control" id="releaseYear" name="releaseYear" value="1" required>
    
    
    <label for="languageID"><em>Enter New Film Language ID:</em></label> 
    <input type="number" class="form-control" id="languageID" name="languageID" value="1" required>
    <br>
    ...
    <input type="number" class="form-control" id="rentalDuration" name="rentalDuration" value="1" required>
    
    
    <label for="rentalRate"><em>Enter New Film Rental Rate:</em></label>
    <input type="number" class="form-control" id="rentalRate" name="rentalRate" value="1" required>
    
    
    <label for="length"><em>Enter New Film Length:</em></label>
    <input type="number" class="form-control" id="length" name="length" value="1" required>
    
    
    <label for="replacementCost"><em>Enter New Film Replacement Cost:</em></label>
    <input type="number" class="form-control" id="replacementCost" name="replacementCost" value="1" required>
